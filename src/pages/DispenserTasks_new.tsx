...
const DispenserTasks = () => {
  ...
  // Group assignments by day for the weekly view
  const assignmentsByDay = assignedProducts.reduce((acc, assignment) => {
    const date = new Date(assignment.date_field);
    ...
    return acc;
  }, {} as Record<string, UnifiedAssignment[]>);

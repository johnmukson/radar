...
const Dashboard = () => {
  const { user } = useAuth();
  const { hasAdminAccess, role, loading: roleLoading } = useUserRole();
  ...
  return (
    <div className="flex-1 flex flex-col h-screen">
      ...
      <main className="flex-1 overflow-y-auto p-6 space-y-8">
        ...
        {/* AI recommendation button for regional managers and system administrators */}
        {(!roleLoading && (role === 'regional_manager' || role === 'system_admin')) && (

-- ============================================================================
-- Fix Ambiguous branch_id Column Reference
-- Migration: 20250110000003_fix_ambiguous_branch_id.sql
-- Description: Fixes ambiguous branch_id reference by using table aliases
-- ============================================================================

-- Update the generate_ai_recommendations function with proper table aliases
...
COMMENT ON FUNCTION public.generate_ai_recommendations IS 'Generates AI-powered recommendations based on stock data analysis. Cost reduction recommendations focus on items expiring in 60-90 days to allow proactive planning.';
